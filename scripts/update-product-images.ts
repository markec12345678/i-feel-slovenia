...
async function main() {
  console.log("=== POSODOBA SLIK IZDELKOV ===\n");

  const batches = ["/tmp/products-batch1.json", "/tmp/products-batch2.json", "/tmp/products-batch3.json"];
  ...
  console.log(`Skupno izdelkov za posodobitev: ${Object.keys(merged).length}\n`);
