...
const listings = [
  // === HOTELI ===
  {
    ...
    phone: "+386 4 579 1500",
    email: "info@vilabled.si",
    website: "https://www.vilabled.si",
  ...
  // === RESTAVRACIJE ===
  {
    ...
    phone: "+386 1 433 6050",
    website: "https://www.restavracijajb.si",
    images: JSON.stringify([
  ...
  },
  {
    name: "Penzion Berc",
    slug: "penzion-berc",
    description: "Tradicionalna slovenska kuhinja v Gorenjski s svežimi lokalnimi sestavinami.",
    longDescription:
      "Penzion Berc ponuja tradicionalne slovenske jedi z modernim pridihom. Znani po domači krvavici, ajdovih žgancih in štrukljih. Sproščen ambient za družine in skupine.",
    category: "restaurant",
    destinationId: "bled",
    destinationName: "Bled",
    address: "Vesca 3, 4247 Begunje na Gorenjskem",
    phone: "+386 4 534 1020",
    website: "https://www.penzionberc.si",
    images: JSON.stringify([
  ...
  {
    name: "Restavracija Trta",
    slug: "restavracija-trta",
    description: "Vinska klet in restavracija v Mariboru ob Stari trti.",
    longDescription:
      "Restavracija ob najstarejši trti na svetu (400+ let). Ponuja tradicionalne štajerske jedi in vrhunska slovenska vina. Idealen za vinske ljubitelje.",
    category: "restaurant",
    destinationId: "maribor",
    destinationName: "Maribor",
    address: "Vojašniška 8, 2000 Maribor",
    phone: "+386 2 251 3000",
